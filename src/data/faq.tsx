export default [
  ...
  },
  {
    ...
    answer: (
      <div>
        <p>TECC will be comprised of two rounds:</p>
        <ol className="list-disc pl-4">
          <li>
            All teams have a week to solve a real-life business case. Solutions
  ...
  },
  {
    ...
    answer: (
      <p>
        Teams have to consist of 4 eligible students, which can be formed across
        schools or states. Find some other friends or classmates and sign-up!
      </p>
    ),
  },
  {
    ...
    answer: (
      <p>
        Simple, just click this form here [link]! Only one person from each team
        needs to sign up to create a new team.
      </p>
    ),
  },
  {
